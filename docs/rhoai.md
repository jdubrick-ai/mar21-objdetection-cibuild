...
3) Access the `workbench` named `mar21-objdetection-cibuild-notebook`.
...
5) In the terminal, run `cd mar21-objdetection-cibuild` to navigate to your sample app's directory.
